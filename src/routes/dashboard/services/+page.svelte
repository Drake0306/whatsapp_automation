...
<div class="space-y-6">
  ...
  <div class="border-t pt-6">
    <div class="flex items-center justify-between">
      <div>
        <h3 class="text-lg font-semibold">Availability Blocks</h3>
    ...
    {#if blocks.length === 0}
      <p class="mt-4 text-sm text-muted-foreground">No active blocks. Your full schedule is open for bookings.</p>
    {:else}
